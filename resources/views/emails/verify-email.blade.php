                ...
                <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px">
                    ...
                    <tr>
                        <td align="center" style="padding-bottom:20px">
                            <h2 style="font-size:24px;color:#000;margin:0;font-weight:normal">Email Verification
                                Required</h2>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center" style="padding-bottom:30px">
                            <p style="font-size:16px;color:#000;margin:0;line-height:1.5;text-align:center">
                                Terima kasih telah mendaftar di SATU DATA TERNATE.<br>
                    ...
                    <tr>
                        <td align="center" style="padding-bottom:30px">
                            <a href="{{ $actionUrl }}"
                                style="display:inline-block;background:#3b82f6;color:#fff;padding:12px 24px;text-decoration:none;border-radius:4px;font-size:14px">Verifikasi
                                Email</a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center">
                            <p style="font-size:13px;color:#000;margin:0;line-height:1.5;text-align:center">
                                Link ini berlaku selama 1 jam. Jika Anda tidak mendaftar akun ini,<br>
