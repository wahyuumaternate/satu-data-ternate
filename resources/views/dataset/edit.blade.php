            ...
            <div class="col-xl-10">
                <div class="import-wizard">
                    ...
                    <div class="wizard-header">
                        <h2>Edit Dataset: {{ $dataset->title }}</h2>
                    </div>
                    ...
                    <!-- Form -->
                    <form action="{{ route('dataset.update', $dataset->id) }}" method="POST" enctype="multipart/form-data"
                        id="datasetForm">
                        @csrf
                        @method('PUT')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="tag-input-container">
                                            ...
                                            <input type="hidden" name="tags" id="tagsHidden"
                                                value="{{ old('tags', is_array($dataset->tags) ? implode(',', $dataset->tags) : $dataset->tags) }}">
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select @error('license') is-invalid @enderror"
                                                    ...
                                                    <option value="cc-by"
                                                        {{ old('license', $dataset->license) == 'cc-by' ? 'selected' : '' }}>
                                                        Creative Commons
                                                        BY</option>
                                                    <option value="cc-by-sa"
                                                        {{ old('license', $dataset->license) == 'cc-by-sa' ? 'selected' : '' }}>
                                                        Creative
                                                        Commons BY-SA</option>
                                                    <option value="public-domain"
                                                        {{ old('license', $dataset->license) == 'public-domain' ? 'selected' : '' }}>
                                                        Public
                                                        Domain</option>
                                                    <option value="proprietary"
                                                        {{ old('license', $dataset->license) == 'proprietary' ? 'selected' : '' }}>
                                                        Proprietary
                                                    </option>
                                                </select>
                                                @error('license')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-select @error('topic') is-invalid @enderror"
                                                    ...
                                                    <option value="Ekonomi"
                                                        {{ old('topic', $dataset->topic) == 'Ekonomi' ? 'selected' : '' }}>
                                                        Ekonomi</option>
                                                    <option value="Infrastruktur"
                                                        {{ old('topic', $dataset->topic) == 'Infrastruktur' ? 'selected' : '' }}>
                                                        Infrastruktur</option>
                                                    <option value="Kemiskinan"
                                                        {{ old('topic', $dataset->topic) == 'Kemiskinan' ? 'selected' : '' }}>
                                                        Kemiskinan
                                                    </option>
                                                    <option value="Kependudukan"
                                                        {{ old('topic', $dataset->topic) == 'Kependudukan' ? 'selected' : '' }}>
                                                        Kependudukan
                                                    </option>
                                                    <option value="Kesehatan"
                                                        {{ old('topic', $dataset->topic) == 'Kesehatan' ? 'selected' : '' }}>
                                                        Kesehatan
                                                    </option>
                                                    <option value="Lingkungan Hidup"
                                                        {{ old('topic', $dataset->topic) == 'Lingkungan Hidup' ? 'selected' : '' }}>
                                                        Lingkungan Hidup</option>
                                                    <option value="Pariwisata & Kebudayaan"
                                                        {{ old('topic', $dataset->topic) == 'Pariwisata & Kebudayaan' ? 'selected' : '' }}>
                                                        Pariwisata & Kebudayaan</option>
                                                    <option value="Pemerintah & Desa"
                                                        {{ old('topic', $dataset->topic) == 'Pemerintah & Desa' ? 'selected' : '' }}>
                                                        Pemerintah & Desa</option>
                                                    <option value="Pendidikan"
                                                        {{ old('topic', $dataset->topic) == 'Pendidikan' ? 'selected' : '' }}>
                                                        Pendidikan
                                                    </option>
                                                    <option value="Sosial"
                                                        {{ old('topic', $dataset->topic) == 'Sosial' ? 'selected' : '' }}>
                                                        Sosial</option>
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-select @error('sector') is-invalid @enderror"
                                                    ...
                                                    <option value="pemerintahan"
                                                        {{ old('sector', $dataset->sector) == 'pemerintahan' ? 'selected' : '' }}>
                                                        Pemerintahan</option>
                                                    <option value="swasta"
                                                        {{ old('sector', $dataset->sector) == 'swasta' ? 'selected' : '' }}>
                                                        Swasta</option>
                                                    <option value="akademik"
                                                        {{ old('sector', $dataset->sector) == 'akademik' ? 'selected' : '' }}>
                                                        Akademik
                                                    </option>
                                                    <option value="non-profit"
                                                        {{ old('sector', $dataset->sector) == 'non-profit' ? 'selected' : '' }}>
                                                        Non-Profit
                                                    </option>
                                                </select>
                                                @error('sector')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select
                                                    ...
                                                    <option value="diskominfo"
                                                        {{ old('responsible_person', $dataset->responsible_person) == 'diskominfo' ? 'selected' : '' }}>
                                                        Dinas Komunikasi dan Informatika</option>
                                                    <option value="bps"
                                                        {{ old('responsible_person', $dataset->responsible_person) == 'bps' ? 'selected' : '' }}>
                                                        Badan
                                                        Pusat Statistik</option>
                                                    <option value="bappeda"
                                                        {{ old('responsible_person', $dataset->responsible_person) == 'bappeda' ? 'selected' : '' }}>
                                                        Bappeda</option>
                                                    <option value="lainnya"
                                                        {{ old('responsible_person', $dataset->responsible_person) == 'lainnya' ? 'selected' : '' }}>
                                                        Lainnya</option>
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('contact', $dataset->contact) }}">
                                                @error('contact')
                                                    <div class="text-danger help-text">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select @error('classification') is-invalid @enderror"
                                                    ...
                                                    <option value="publik"
                                                        {{ old('classification', $dataset->classification) == 'publik' ? 'selected' : '' }}>
                                                        Publik
                                                    </option>
                                                    <option value="internal"
                                                        {{ old('classification', $dataset->classification) == 'internal' ? 'selected' : '' }}>
                                                        Internal</option>
                                                    <option value="terbatas"
                                                        {{ old('classification', $dataset->classification) == 'terbatas' ? 'selected' : '' }}>
                                                        Terbatas</option>
                                                    <option value="rahasia"
                                                        {{ old('classification', $dataset->classification) == 'rahasia' ? 'selected' : '' }}>
                                                        Rahasia
                                                    </option>
                                                </select>
                                        ...
                                        <div class="d-flex gap-4">
                                            <div class="form-check">
                                                <input class="form-check-input @error('status') is-invalid @enderror"
                                                    ...
                                                    {{ old('status', $dataset->status) == 'sementara' ? 'checked' : '' }}
                                                    required>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input @error('status') is-invalid @enderror"
                                                    ...
                                                    {{ old('status', $dataset->status) == 'tetap' ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('data_source', $dataset->data_source) }}">
                                                @error('data_source')
                                                    <div class="text-danger help-text">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('data_period', $dataset->data_period) }}">
                                                @error('data_period')
                                                    <div class="text-danger help-text">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select
                                                    ...
                                                    <option value="harian"
                                                        {{ old('update_frequency', $dataset->update_frequency) == 'harian' ? 'selected' : '' }}>
                                                        Harian
                                                    </option>
                                                    <option value="mingguan"
                                                        {{ old('update_frequency', $dataset->update_frequency) == 'mingguan' ? 'selected' : '' }}>
                                                        Mingguan</option>
                                                    <option value="bulanan"
                                                        {{ old('update_frequency', $dataset->update_frequency) == 'bulanan' ? 'selected' : '' }}>
                                                        Bulanan</option>
                                                    <option value="tahunan"
                                                        {{ old('update_frequency', $dataset->update_frequency) == 'tahunan' ? 'selected' : '' }}>
                                                        Tahunan</option>
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('geographic_coverage', $dataset->geographic_coverage) }}">
                        ...
                        <div class="action-buttons">
                            ...
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-primary-custom" name="action" value="update">
                                    <i class="bi bi-check-circle me-2"></i>Update Dataset
                                </button>
                            </div>
                        </div>
                    </form>
