                ...
                <div class="card shadow-lg">
                    <div class="card-header bg-gradient-warning">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex gap-2">
                                <a href="{{ route('mapset.show', $mapset->id) }}" class="btn btn-light btn-sm">
                                    <i class="fas fa-eye me-1"></i> Lihat
                                </a>
                                <a href="{{ route('mapset.index') }}" class="btn btn-outline-light btn-sm">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('mapset.update', $mapset->uuid) }}" method="POST"
                            enctype="multipart/form-data" id="mapsetForm">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-step active" id="section-1">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-text">Format: JPG, PNG, GIF. Maksimal 2MB. Kosongkan jika
                                                tidak ingin mengubah.</div>
                                            <div id="preview-image" class="mt-2">
                                                @if ($mapset->gambar)
                                                    <div class="current-image mb-2">
                                                        <small class="text-muted d-block">Gambar saat ini:</small>
                                                        <img src="{{ asset('storage/' . $mapset->gambar) }}"
                                                            alt="Current preview"
                                                            style="max-width: 100%; max-height: 150px; border-radius: 5px; border: 1px solid #dee2e6;">
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                                ...
                                <div class="text-end mt-4">
                                    <button type="button" class="btn btn-warning" onclick="nextStep(1)">
                            ...
                            <div class="form-step" id="section-2">
                                ...
                                @if ($mapset->geometry_data)
                                    <div class="alert alert-info">
                                        <i class="fas fa-info-circle me-2"></i>
                                        <strong>Data Geometri Saat Ini:</strong>
                                        <ul class="mb-0 mt-2">
                                            <li>Tipe Input: {{ ucfirst($mapset->input_type ?? 'Tidak diketahui') }}</li>
                                            @if ($mapset->input_type === 'coordinates')
                                                @php
                                                    $coordinates = json_decode($mapset->geometry_data, true);
                                                    $coordCount = is_array($coordinates) ? count($coordinates) : 0;
                                                @endphp
                                                <li>Jumlah Koordinat: {{ $coordCount }} titik</li>
                                            @endif
                                            <li>Terakhir diupdate: {{ $mapset->updated_at->format('d/m/Y H:i') }}</li>
                                        </ul>
                                        <small class="text-muted">Anda dapat memperbarui data geometri dengan mengunggah
                                            data baru di bawah ini.</small>
                                    </div>
                                @endif
                                ...
                                <div class="input-type-selector mb-4">
                                    <h6 class="text-center mb-3">
                                        ...
                                        Pilih Metode Input Data Geometri Baru (Opsional)
                                    </h6>
                                    <div class="input-options">
                                        ...
                                        <div class="input-option" data-type="keep" onclick="selectInputType('keep')">
                                            <div class="option-icon">
                                                <i class="fas fa-save"></i>
                                            </div>
                                            <div class="option-title">Pertahankan Data</div>
                                            <div class="option-description">Gunakan data geometri yang sudah ada tanpa
                                                perubahan</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="input-content" id="coordinates-content">
                                    <div class="coord-input-group">
                                        ...
                                        <div id="coordinate-inputs">
                                            @if ($mapset->input_type === 'coordinates' && $mapset->geometry_data)
                                                @php
                                                    $existingCoords = json_decode($mapset->geometry_data, true);
                                                @endphp
                                                @if (is_array($existingCoords) && count($existingCoords) > 0)
                                                    @foreach ($existingCoords as $index => $coord)
                                                        <div class="coord-input-row" data-index="{{ $index }}">
                                                            ...
                                                            <div class="coord-actions">
                                                                ...
                                                                @else
                                                                    ...
                                                                    <button type="button" class="btn btn-remove-coord"
                                                                        onclick="removeCoordinateInput(this)">
                                                    ...
                                                    @endforeach
                                                @else
                                                    <!-- Default single coordinate input -->
                                                ...
                                                @endif
                                            @else
                                                <!-- Default single coordinate input for non-coordinate mapsets -->
                                                <div class="coord-input-row">
                                                    <div class="coord-field">
                                                        <label class="form-label">Nama Lokasi</label>
                                                        <input type="text" class="form-control coord-name"
                                ...
                                <!-- Keep Current Data Content -->
                                <div class="input-content" id="keep-content">
                                    <div class="alert alert-success">
                                        <i class="fas fa-check-circle me-2"></i>
                                        <strong>Data Geometri Saat Ini Akan Dipertahankan</strong>
                                        <p class="mb-0 mt-2">Data geometri yang sudah ada tidak akan diubah. Hanya
                                            informasi dasar mapset yang akan diperbarui.</p>
                                    </div>
                                </div>
                            ...
                            <div class="form-step" id="section-3">
                                ...
                                <div class="summary-card">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p><strong>Nama:</strong> <span id="summary-nama">{{ $mapset->nama }}</span>
                                            </p>
                                            <p><strong>Topik:</strong> <span
                                                    id="summary-topic">{{ $topics[$mapset->topic] ?? $mapset->topic }}</span>
                                            </p>
                                            <p><strong>Deskripsi:</strong> <span
                                                    id="summary-deskripsi">{{ $mapset->deskripsi ?: 'Tidak ada deskripsi' }}</span>
                                            </p>
                                            <p><strong>Visibilitas:</strong> <span
                                                    id="summary-visibility">{{ $mapset->is_visible ? 'Publik' : 'Privat' }}</span>
                                            </p>
                                        </div>
                                        <div class="col-md-6">
                                            <p><strong>Metode Input:</strong> <span
                                                    id="summary-input-type">{{ ucfirst($mapset->input_type) ?? 'Tidak diketahui' }}</span>
                                            </p>
                                            <p><strong>Status Update:</strong> <span
                                                    id="summary-update-status">Mempertahankan data lama</span></p>
                                            <div id="summary-geometry">
                                                @if ($mapset->input_type === 'coordinates' && $mapset->geometry_data)
                                                    @php
                                                        $coords = json_decode($mapset->geometry_data, true);
                                                        $coordCount = is_array($coords) ? count($coords) : 0;
                                                    @endphp
                                                    <p><strong>Koordinat Saat Ini:</strong> {{ $coordCount }} titik</p>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
...
@push('scripts')
    ...
    <script>
        let currentStep = 1;
        let selectedInputType = 'keep'; // Default to keep existing data
        let previewMap = null;
        let coordinateCount =
            {{ $mapset->input_type === 'coordinates' && $mapset->geometry_data ? count(json_decode($mapset->geometry_data, true) ?: []) : 1 }};
        ...
        function validateStep(step) {
            if (step === 1) {
                ...
                // For edit mode, if no input type is selected, we keep the existing data
                if (!selectedInputType) {
                    selectedInputType = 'keep';
                    document.getElementById('input_type').value = 'keep';
                }
        ...
        function updateSummary() {
            document.getElementById('summary-nama').textContent =
                document.getElementById('nama').value || '{{ $mapset->nama }}';

            const topicSelect = document.getElementById('topic');
            document.getElementById('summary-topic').textContent =
                topicSelect.options[topicSelect.selectedIndex].text || '{{ $topics[$mapset->topic] ?? $mapset->topic }}';
            ...
            const inputTypeLabels = {
                ...
                'kmz': 'File KMZ/KML',
                'keep': 'Mempertahankan Data Lama'
            };
            document.getElementById('summary-input-type').textContent =
                inputTypeLabels[selectedInputType] || 'Mempertahankan Data Lama';

            // Update status
            const statusText = selectedInputType === 'keep' ? 'Mempertahankan data lama' :
                'Akan diperbarui dengan data baru';
            document.getElementById('summary-update-status').textContent = statusText;
        }
        ...
        function initPreviewMap() {
            ...
            // Load geometry preview based on selected input type
            if (selectedInputType === 'coordinates') {
                displayCoordinatesOnMap();
            } else if (selectedInputType === 'keep' && '{{ $mapset->input_type }}' === 'coordinates') {
                displayExistingCoordinatesOnMap();
            } else {
                displayGenericPreview();
            }
        }
        ...
        function displayExistingCoordinatesOnMap() {
            @if ($mapset->input_type === 'coordinates' && $mapset->geometry_data)
                const existingCoords = @json(json_decode($mapset->geometry_data, true));
                if (existingCoords && existingCoords.length > 0) {
                    const bounds = [];
                    existingCoords.forEach((coord, index) => {
                        const lat = parseFloat(coord.latitude);
                        const lng = parseFloat(coord.longitude);
                        const name = coord.name || `Lokasi ${index + 1}`;
        ...
        function displayGenericPreview() {
            const mapContainer = document.getElementById('preview-map');
            mapContainer.innerHTML = `
            <div class="d-flex justify-content-center align-items-center h-100 bg-light">
                <div class="text-center text-muted">
                    <i class="fas fa-map fa-3x mb-3"></i>
                    <p>Preview untuk data geometri yang ada</p>
                    <small>Data akan diproses sesuai dengan pilihan yang dibuat</small>
                </div>
            </div>
        `;
        }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Set default selection to keep data
            selectInputType('keep');
            ...
            document.getElementById('gambar').addEventListener('change', function(e) {
                ...
                if (file) {
                    ...
                    reader.onload = function(e) {
                        ...
                        const currentImage = previewDiv.querySelector('.current-image');
                        if (currentImage) {
                        ...
                        newPreview.className = 'new-preview mt-2';
                        newPreview.innerHTML = `
                            <small class="text-muted d-block">Preview gambar baru:</small>
                            <img src="${e.target.result}" alt="New preview" style="max-width: 100%; max-height: 150px; border-radius: 5px; border: 1px solid #dee2e6;">
                        `;
                        previewDiv.appendChild(newPreview);
                    };
                    reader.readAsDataURL(file);
                } else {
                    // Show current image again if no new file
                    const currentImage = previewDiv.querySelector('.current-image');
                    if (currentImage) {
                        currentImage.style.display = 'block';
                    }
                    // Remove new preview
                    const newPreview = previewDiv.querySelector('.new-preview');
                    if (newPreview) {
                        newPreview.remove();
                    }
                }
            ...
            // Auto-update coordinate count if existing data
            @if ($mapset->input_type === 'coordinates' && $mapset->geometry_data)
                coordinateCount = {{ count(json_decode($mapset->geometry_data, true) ?: []) }};
            @endif
        });
    </script>
@endpush
