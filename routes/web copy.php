...
Route::middleware('auth')->group(function () {
    ...
    Route::get('visualisasi/download-template', [VisualisasiController::class, 'downloadTemplate'])
        ->name('visualisasi.download-template');

    // Index - list all visualisasi
    Route::get('visualisasi', [VisualisasiController::class, 'index'])
        ->name('visualisasi.index');

    // Create - show form to create new visualisasi
    Route::get('visualisasi/create', [VisualisasiController::class, 'create'])
        ->name('visualisasi.create');

    // Store - save new visualisasi
    Route::post('visualisasi', [VisualisasiController::class, 'store'])
        ->name('visualisasi.store');

    // Show - display specific visualisasi
    Route::get('visualisasi/{visualisasi}', [VisualisasiController::class, 'show'])
        ->name('visualisasi.show');

    // Edit - show form to edit visualisasi
    Route::get('visualisasi/{visualisasi}/edit', [VisualisasiController::class, 'edit'])
        ->name('visualisasi.edit');

    // Update - save changes to visualisasi
    Route::put('visualisasi/{visualisasi}', [VisualisasiController::class, 'update'])
        ->name('visualisasi.update');

    Route::patch('visualisasi/{visualisasi}', [VisualisasiController::class, 'update'])
        ->name('visualisasi.update');

    // Destroy - delete visualisasi
    Route::delete('visualisasi/{visualisasi}', [VisualisasiController::class, 'destroy'])
        ->name('visualisasi.destroy');

    // Export routes (optional)
    Route::get('visualisasi/{visualisasi}/export-csv', [VisualisasiController::class, 'exportCsv'])
        ->name('visualisasi.export-csv');

    Route::get('visualisasi/{visualisasi}/export-json', [VisualisasiController::class, 'exportJson'])
        ->name('visualisasi.export-json');
