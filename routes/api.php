    ...
    */
        Route::prefix('datasets')
            ...
            ->group(function () {
                ...
                // ✅ BENAR - download di atas show
                Route::get('/{dataset:slug}/download', [DatasetApiController::class, 'download']);
                Route::get('/{dataset:slug}', [DatasetApiController::class, 'show']);
            });
